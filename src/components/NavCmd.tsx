...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className={`fixed top-0 w-screen transition-opacity duration-150 ${isVisible ? 'bg-black p-4 border-b-2 z-30 border-dashed border-green-500 opacity-100' : 'bg-gradient-to-r z-40 from-gray-900 via-blue-800 to-blue-500 p-4 opacity-100'}`}>
